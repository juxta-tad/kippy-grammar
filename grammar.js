...
const KEYWORDS = [
	'pub', 'let', 'rec', 'alias', 'distinct', 'tag', 'record',
	'choice', 'cert', 'expect', 'if', 'then', 'else', 'match', 'in', 'where',
	'with', 'shape', 'module', 'use', 'build', 'type', 'fit', 'derive', 'sig',
	'fn', 'test', 'or', 'and', 'not', 'mod', 'as', 'self', 'Self', 'unit',
];
